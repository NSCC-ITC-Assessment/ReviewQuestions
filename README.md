...
| `show_answers`                 | No       | `false`                                     | When `true`, each question is immediately followed by its answer labelled **Answer:**. Answers are written in plain, everyday language and avoid technical jargon. Useful for generating an instructor copy alongside the student copy.                                                                                                                                                                  |
